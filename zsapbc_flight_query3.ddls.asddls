...
define view zsapbc_flight_query3 with parameters
     ...
     p_year_2: rscalyear     
     as select from zsapbc_flight_cube3( p_display_currency:  $parameters.p_display_currency, 
...
--    region,
    zsapbc_flight_cube3._region[datefrom = $parameters.p_keydate and dateto = $parameters.p_keydate].region,    
