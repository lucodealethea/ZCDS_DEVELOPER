...
define view zsapbc_region_text3 as select from zsapbc_region3 {
 ...
 select from zsapbc_region3 {
  ...
  @Semantics.text: true
  case 
  when region = 'EU' then 'Europ�ische Union'
